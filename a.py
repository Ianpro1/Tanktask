...
if __name__ == "__main__":
    ...
    process.append(mp.Process(target=play_env, args=(True, ENV_NUM, net, net, exp_queue, device, device)))
    ...
    while(1):
        ...
        #c_p_a = (1-p_a)
        #variance_loss = BETA_ENTROPY * (p_a * logprob_a + c_p_a * torch.log10(c_p_a)).mean()

        loss = policy_loss + mse_loss
        loss.backward()
        opt.step()
